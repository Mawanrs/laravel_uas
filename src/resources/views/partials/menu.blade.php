        ...
        @can('fn_b_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/tables*") ? "c-show" : "" }} {{ request()->is("admin/bookings*") ? "c-show" : "" }} {{ request()->is("admin/prices*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan --}}
                    @can('tambah_siswaa_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.tambah_siswaa.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/tambah_siswaas") || request()->is("admin/tambah_siswaas/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-users c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.tambah_siswaa.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('penilaian_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("admin.penilaians.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/penilaians") || request()->is("admin/penilains/*") ? "c-active" : "" }}">
                            <i class="fa-fw far fa-money-bill-alt c-sidebar-nav-icon">
            
                            </i>
                            {{ trans('cruds.penilaians.title') }}
                        </a>
                    </li>
                @endcan
                </ul>
